...
# retrieve winner tickets and profit
...
final_total_paid_string = f"Total Paid is now ${total_profit - ticket_won:.2f}"
...
adjusted_explanation = (f"We have given a ticket worth ${ticket_won:.2f} which means \n"
                        f"our sales have decreases by ${ticket_won:.2f} and our profit \n"
